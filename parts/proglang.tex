...
\begin{defn}[Konzervatív kiterjesztés\protect{\cite[3.2~definíció]{Felleisen90}}]\label{defn:conservative_extension}
...
Egy programozási nyelv \textbf{hasznos} (\textit{useful}) ha lehetővé teszi, hogy a programozó gyorsan és hatékonyan írja meg a feladatát megvalósító programot\cite{Csornyei}. A hasznosság fő metrikái:
\begin{description}
